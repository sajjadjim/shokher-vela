            ...
            <div className="card bg-base-100  w-11/12 mx-auto mt-20 max-w-sm shrink-0 shadow-2xl mb-20 ">
                <div className="card-body">
                    <form onSubmit={handleRegister} className="fieldset">
                        ...
                        <button type='submit' className="btn btn-neutral mt-4  border-none text-white my-2">Register</button>
                        ...
                        <p className='text-center'>Already register?<br></br> Please <Link to='/login'> <span className='text-blue-400'>Login</span> </Link> </p>
                    </form>
                </div>
            </div>
            <Footer ></Footer>
